...
func _enter_tree() -> void:
	...
	_notes_tab.text = editor_settings.get_project_metadata(
			"notes_tab", "notes", "")
...
func _update_settings() -> void:
	...
	var editor_settings: EditorSettings =\
			get_editor_interface().get_editor_settings()
	_notes_tab.caret_block_mode = editor_settings.get(
			"text_editor/cursor/block_caret")
	_notes_tab.caret_blink = editor_settings.get(
			"text_editor/cursor/caret_blink")
	_notes_tab.caret_blink_speed = editor_settings.get(
			"text_editor/cursor/caret_blink_speed")
	_notes_tab.caret_moving_by_right_click = editor_settings.get(
